...
Number of cache look-ups: 49896
Number of cache hits: 20819
Number of cache insertions: 29338
Number of cache collisions: 1336
Number of cache deletions: 21080
Cache used slots = 17.79% (expected 10.55%)
Soft limit for cache size: 100352
Number of buckets in unique table: 25088
Used buckets in unique table: 12.31% (expected 12.44%)
...
Maximum resident size            = 6991872K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1847
Swaps = 0
Input blocks = 0
Output blocks = 0
Context switch (voluntary) = 2
Context switch (involuntary) = 32
